        ...
        if (!worldObj.isRemote) {
            ...
            if (coilStatus == 1) {
                if (currentRecipe == null) {
                    ...
                    /*
                     * if (inventory.hasChanged) { if (!validateRecipe()) { resetCrafter();
                     * System.out.println("reset1"); return; } }//
                     */
                    if (!hasStartedCrafting) {
                        ...
                        if (crafingTickTime < currentRecipe.getTickTime()) {
                            ...
                            if (canFitStack(currentRecipe.getOutput(), outputStackSlot, true)) {
                                ...
                                /*
                                 * decrStackSize(topStackSlot, currentRecipe.getTopInput().stackSize); if
                                 * (currentRecipe.getBottomInput() != null) { decrStackSize(bottomStackSlot,
                                 * currentRecipe.getBottomInput().stackSize); }//
                                 */
                                crafingTickTime = 0;
                                if (!validateRecipe()) {
                                    resetCrafter();
