...
import page.codeberg.unix_supremacist.pup.pda.util.GuiButtonCustomTexture;
    ...
    public void initGui() {
        ...
        buttonList.add(
            new GuiButtonCustomTexture(
                ...
                80,
                20,
                new ItemStack(ModBlocks.MachineCasing),
                "INDEX",
                "MULTIBLOCKS"));
        buttonList.add(
            new GuiButtonCustomTexture(
                ...
                80,
                20,
                new ItemStack(ModItems.upgrades),
                "INDEX",
                "UPGRADES"));
