...
public class ContainerPlateBender extends ContainerCrafting {

    EntityPlayer player;

    TilePlateBender tile;
    ...
    public ContainerPlateBender(TilePlateBender tileCentrifuge, EntityPlayer player) {
