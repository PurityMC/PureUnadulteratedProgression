...
import page.codeberg.unix_supremacist.pup.pda.util.GuiButtonTextOnly;
...
public class ItemsPage extends TitledPage {
    ...
    public void actionPerformed(GuiButton button) {
        if (button instanceof GuiButtonTextOnly) collection.changeActivePage(((GuiButtonTextOnly) button).LINKED_PAGE);
