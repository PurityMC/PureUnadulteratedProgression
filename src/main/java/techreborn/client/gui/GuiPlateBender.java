...
import techreborn.client.container.ContainerPlateBender;
import techreborn.tiles.TilePlateBender;

public class GuiPlateBender extends GuiContainer {

    private static final ResourceLocation texture = new ResourceLocation(
            "techreborn",
            "textures/gui/industrial_centrifuge.png");

    TilePlateBender centrifuge;

    public GuiPlateBender(EntityPlayer player, TilePlateBender tileCentrifuge) {
        super(new ContainerPlateBender(tileCentrifuge, player));
        this.xSize = 176;
        this.ySize = 167;
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        ...
        String namePt2 = StatCollector.translateToLocal("tile.techreborn.platebender.name").replace(namePt1 + " ", "");
