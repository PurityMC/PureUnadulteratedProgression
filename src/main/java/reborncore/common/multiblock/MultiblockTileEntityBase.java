...
/**
 * Base logic class for Multiblock-connected tile entities. Most multiblock machines should derive from this and
 * implement their game logic in certain abstract methods.
 */
