...
public class ModBlocks {
    ...
    public static Block plateBender;
    ...
    public static void init() {
        ...
        plateBender = new BlockPlateBender();
        GameRegistry.registerBlock(plateBender, "techreborn.platebender");
        GameRegistry.registerTileEntity(TilePlateBender.class, "TilePlateBenderTR");
