...
public class GuiHandler implements IGuiHandler {
    ...
    public static final int plateBenderID = 31;
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        } else if (ID == plateBenderID) {
            return new ContainerPlateBender((TilePlateBender) world.getTileEntity(x, y, z), player);
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        if (ID == thermalGeneratorID) {
            ...
            return new GuiPlateBender(player, (TilePlateBender) world.getTileEntity(x, y, z));
        } else if (ID == rollingMachineID) {
