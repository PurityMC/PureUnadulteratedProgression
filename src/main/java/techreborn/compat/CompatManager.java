...
public class CompatManager {
    ...
    public void registerCompact(Class<?> moduleClass, Object... objs) {
        ...
        boolean shouldLoad = ConfigTechReborn.config.get(
                ConfigTechReborn.CATEGORY_INTEGRATION,
                "Compat:" + moduleClass.getSimpleName(),
                true,
                "Should the " + moduleClass.getSimpleName() + " be loaded?").getBoolean(true);
        ...
        for (Object obj : objs) {
            if (obj instanceof String) {
                ...
                Core.logHelper.info(
                        "Compat module " + moduleClass.getSimpleName()
                                + " has not been loaded because it was told not to");
                return;
            }
        }
